...
class table_mt_vote_child extends discuz_table {
	public function __construct() {
		$this->_table = 'mt_vote_child';
		$this->_pk    = 'id';
	...
	public function increase($id, $setarr ,$action ='') {
		$sql = array();
		$allowkey = array('view','voters','votes');
		$operator = '+';
		if($action){
			$operator = $action;
		}
