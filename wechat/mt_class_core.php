...
class core
{
	...
	public static function creatapp() {
		if(!is_object(self::$_app)) {
			self::$_app = mt_discuz_application::instance();
		}
		return self::$_app;
	}
	...
	public static function import($name, $folder = '', $force = true) {
		...
		if(!isset(self::$_imports[$key])) {
			...
			if($name == 'mt_discuz_application'){
				$filename = 'plugin/mt_wechat/wechat/mt_discuz_application.php';
	...
	public static function autoload($class) {
		...
		if($class == 'mt_discuz_application'){
			$file = 'mt_discuz_application';
